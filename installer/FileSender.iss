...
; App icon, already wired in and maintained in the repo — do not replace.
...
; Icon shown on the installer executable (FileSender.exe) itself. The
; installed app's own icon comes from the PyInstaller build instead.
